-- workaround for errors https://github.com/denoland/deno/issues/28794
-- https://raw.githubusercontent.com/onion108/onion27-nvim-config/refs/heads/main/lua/terminal/tweaks/deno-lsp-correction.lua
